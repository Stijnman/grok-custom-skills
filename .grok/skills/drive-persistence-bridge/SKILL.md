...
description: >
  Persists agent artifacts to cloud drive storage. Use when saving reports, ba
  ckups, or user says save to drive, persist output. Triggers: save to drive, 
  persist output, upload report, cloud backup.
version: 1.1.0
author: Stijnman
license: MIT
metadata:
