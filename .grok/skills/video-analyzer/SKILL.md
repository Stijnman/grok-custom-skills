...
name: video-analyzer
description: >
  Analyzes video content for scenes, text, and summaries. Use when user shares
   video or says analyze video, what's in this video. Triggers: analyze video,
   what's in this video, video summary, review video.
version: 1.1.0
author: Stijnman
license: MIT
metadata:
